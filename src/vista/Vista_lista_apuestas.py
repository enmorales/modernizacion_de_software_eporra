...
class Vista_lista_apuestas(QWidget):
    ...
    def __init__(self, interfaz, aniadir_activo):
        """
        ...
        self.aniadir_activo = aniadir_activo
    ...
    def inicializar_GUI(self):
       ...
       #Creación de los botones con las diferentes operaciones
        ...
        if not(self.aniadir_activo):
            self.btn_aniadir_apuesta.setDisabled(True)
    ...
    def aniadir_apuesta(self):
        ...
        if dialogo.resultado == 1:
            self.interfaz.aniadir_apuesta(str(dialogo.combobox_competidores.currentText()), dialogo.texto_valor.text(), str(dialogo.combobox_apostadores.currentText()))
    ...
    def editar_apuesta(self, id_apuesta):
        ...
        dialogo.exec_()
        if dialogo.resultado == 1:
            self.interfaz.editar_apuesta(id_apuesta, str(dialogo.combobox_competidores.currentText()), dialogo.texto_valor.text(), str(dialogo.combobox_apostadores.currentText()))
    ...
    def mostrar_mensaje(self, titulo, mensaje):
        ...
        dialogo_error.setText(mensaje)
        dialogo_error.setWindowTitle(titulo)
